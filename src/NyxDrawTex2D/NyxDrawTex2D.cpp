  ...
  namespace vkg
  {
    ...
    struct NyxDrawTex2DData
    {
      ...
      struct Iterators
      {
        ...
        nyx::Iterator<Impl, Proj     > projection ;
      };
      ...
      nyx::Array<Impl, glm::vec3>  d_vertices       ;
      nyx::Array<Impl, glm::mat4>  d_model_trans    ;
      nyx::Array<Impl, Proj>       d_viewproj       ;
      Textures                     drawables        ;
      const Matrix*                camera           ;
       ...
       */
      void setInitialTextures( unsigned index, unsigned model_id ) ;
    ...
    void NyxDrawTex2DData::syncVPMatrix()
    {
      ...
      {
        this->mvp.proj = *this->projection * *this->camera ;
        this->lock.lock() ;
    ...
    void NyxDrawTex2DData::redrawTextures()
    {
      if( this->dirty_flag && this->draw_chain.initialized() && this->drawables.size() != 0 )
      {
        ...
        this->iterator.projection  = this->d_viewproj   .iterator() ;
    ...
    void NyxDrawTex2DData::setProjRef( const Matrix& proj )
    {
    ...
    void NyxDrawTex2DData::setProjRefName( const char* name )
    {
      Log::output( "Module ", this->name.c_str(), " set input projection reference name as \"", name, "\"" ) ;
      this->bus.enroll( this, &NyxDrawTex2DData::setProjRef, iris::OPTIONAL, name ) ;
    }
    ...
    void NyxDrawTex2D::subscribe( unsigned id )
    {
      ...
      data().bus.enroll( this->module_data, &NyxDrawTex2DData::setProjRefName      , iris::OPTIONAL, this->name(), "::projection"     ) ;
